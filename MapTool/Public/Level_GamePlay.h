...
const int m_iPropNum = 10;

const int IMGUI_ColliderMode = 1;
const int IMGUI_PropMode =  2;
...
private:
	...
	/*for Props*/
	HRESULT Creating_Props();
	void IMGUI_Createing_Props();
	class CProp* picking_Prop(int i,int j);
	bool Check_NowProp_NaviIndex();
	void ClearProps();
...
private:
	...
	{	{{L""} ,{L"" } ,{L"" }, {L"" }},
		{{L"../Bin/Resources/LoadData/Colliders_Stage01.dat"},{L"../Bin/Resources/LoadData/Props_Stage01_Layer06.dat"},{L"../Bin/Resources/LoadData/Objects_Stage01.dat"},{L"../Bin/Resources/LoadData/Map_Stage01.dat"}},
		{{L"../Bin/Resources/LoadData/Colliders_Stage02.dat"},{L"../Bin/Resources/LoadData/Props_Stage02.dat"},{L"../Bin/Resources/LoadData/Objects_Stage02.dat"},{L"../Bin/Resources/LoadData/Map_Stage02.dat"}},
		{{L"../Bin/Resources/LoadData/Colliders_Stage03.dat"},{L"../Bin/Resources/LoadData/Props_Stage03.dat"},{L"../Bin/Resources/LoadData/Objects_Stage03.dat"},{L"../Bin/Resources/LoadData/Map_Stage03.dat"}},
	};
	_tchar m_iNowMapPaths_Client[(_int)STAGE::STAGE_END][(_int)CREATE_OBJECT_MODE::MODE_END][MAX_PATH] =
	{ {{L""} ,{L"" } ,{L"" }, {L"" }},
		{{L"../Bin/Resources/LoadData/Colliders_Stage01.dat"},{L"../Bin/Resources/LoadData/Client_Props_Stage01_Layer06.dat"},{L"../Bin/Resources/LoadData/Objects_Stage01.dat"},{L"../Bin/Resources/LoadData/Map_Stage01.dat"}},
		{{L"../Bin/Resources/LoadData/Colliders_Stage02.dat"},{L"../Bin/Resources/LoadData/Props_Stage02.dat"},{L"../Bin/Resources/LoadData/Objects_Stage02.dat"},{L"../Bin/Resources/LoadData/Map_Stage02.dat"}},
		{{L"../Bin/Resources/LoadData/Colliders_Stage03.dat"},{L"../Bin/Resources/LoadData/Props_Stage03.dat"},{L"../Bin/Resources/LoadData/Objects_Stage03.dat"},{L"../Bin/Resources/LoadData/Map_Stage03.dat"}},
	};
	int IMGUI_MODE = 0;
	...
	/*for Prop*/
	vector<class CProp*>m_Props[m_iPropNum+1];
	int m_iPropNowIndex[m_iPropNum+1] = { 0,0,0,0,0 };		//지금 보고 있는 몬스터의 인덱스
	int m_iNowProp = {1};									//지금 배치할 몬스터의 번호
	...
	vector<class CFlat_Virtual_Terrain*> m_vecVirtualTerrain;
